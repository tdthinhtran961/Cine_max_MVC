      ...
      <div class="footer-content">
        <div class="footer-content-column">
          <div class="footer-logo">
            <a class="footer-logo-link" href="<?php echo BASE_URL ?>">
              CineMax
            </a>
          </div>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Designed By: ThienDi. | 0382892550. </a>
          </p>
        </div>
      </div>
    </div>
...
<!-- Initialize Swiper -->
<script>
  let banner = new Swiper(".myBanner", {
    spaceBetween: 30,
    centeredSlides: true,
    // mousewheel: {
    //   invert: true,
